    ...
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "Deine finale Ausgabe muss ein JSON-Objekt sein mit den Feldern: 'Einschätzung', 'Erklärung', und 'Links'. Die EInschätzung darf immer nur ein Wort sein wie Wahr, Falsch, Übertrieben, Unklar, usw. "
