...
class Faktencheck:
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", (
                "Du bist ein reflektierender Faktenchecker-Agent. Deine Aufgabe ist es, die Wahrheit der folgenden Aussage zu überprüfen. "
                ...
                "Deine finale Ausgabe muss ein JSON-Objekt sein mit den Feldern: 'Einschätzung', 'Erklärung', und 'Links'. "
                "Die Erklärung fasst die Ergebnisse zusammen, und 'Links' enthält eine Liste der verwendeten Quellen ohne zusätzliche Beschreibungen. "
